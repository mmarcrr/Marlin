...
#define STRING_CONFIG_H_AUTHOR "(MarcR, Config 2208+dragon)" // Who made the changes.
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 385 } // E0 385 oMG-V2-S-Extruder- for angle 0.9 760
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -55, 0, -1.575 }
